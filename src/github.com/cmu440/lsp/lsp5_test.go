...
func (ts *testSystem) serverReadCorrupted(corrupted bool) {
	var q struct{}
	for {
...
func (ts *testSystem) clientReadCorrupted(corrupted bool) {
	var q struct{}
	for {
...
func (ts *testSystem) testServerWithCorruptedMsg(timeout int) {
	...
	go ts.serverReadCorrupted(false)
	go ts.clientSend(data)
	...
	go ts.serverReadCorrupted(true)
	go ts.clientSend(data)
...
func (ts *testSystem) testClientWithCorruptedMsg(timeout int) {
	...
	go ts.clientReadCorrupted(false)
	go ts.serverSend(data)
	...
	lspnet.SetMsgCorrupted(true)
	defer lspnet.SetMsgCorrupted(false)
	go ts.clientReadCorrupted(true)
	go ts.serverSend(data)
