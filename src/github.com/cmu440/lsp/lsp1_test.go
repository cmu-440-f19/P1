...
func makeParams(epochLimit, epochMillis, windowSize, maxUnackedMessages int) *Params {
	return &Params{
...
func TestBasic3(t *testing.T) {
	newTestSystem(t, 2, makeParams(5, 2000, 1, 1)).
...
func TestBasic5(t *testing.T) {
	newTestSystem(t, 2, makeParams(5, 2000, 2, 1)).
...
func TestBasic6(t *testing.T) {
	newTestSystem(t, 10, makeParams(5, 2000, 20, 10)).
...
func TestBasic7(t *testing.T) {
	newTestSystem(t, 4, makeParams(5, 2000, 2, 2)).
...
func TestBasic8(t *testing.T) {
	newTestSystem(t, 5, makeParams(5, 2000, 10, 10)).
...
func TestBasic9(t *testing.T) {
	newTestSystem(t, 2, makeParams(5, 2000, 10, 10)).
...
func TestSendReceive1(t *testing.T) {
	newTestSystem(t, 1, makeParams(3, 5000, 1, 1)).
...
func TestSendReceive2(t *testing.T) {
	newTestSystem(t, 4, makeParams(3, 5000, 1, 1)).
...
func TestSendReceive3(t *testing.T) {
	newTestSystem(t, 4, makeParams(3, 10000, 1, 1)).
...
func TestRobust1(t *testing.T) {
	newTestSystem(t, 1, makeParams(20, 50, 1, 1)).
...
func TestRobust2(t *testing.T) {
	newTestSystem(t, 3, makeParams(20, 50, 1, 1)).
...
func TestRobust3(t *testing.T) {
	newTestSystem(t, 5, makeParams(20, 50, 1, 1)).
...
func TestRobust4(t *testing.T) {
	newTestSystem(t, 1, makeParams(20, 50, 2, 2)).
...
func TestRobust5(t *testing.T) {
	newTestSystem(t, 3, makeParams(20, 50, 5, 5)).
...
func TestRobust6(t *testing.T) {
	newTestSystem(t, 5, makeParams(20, 50, 10, 10)).
